    ...
    services: [
      {
        ...
        description: 'Interlocucion activa con organismos para defender intereses del sector automotor.',
      },
      {
        title: 'Capacitacion Continua',
        description: 'Programas tecnicos y de gestion para equipos comerciales, administrativos y operativos.',
      },
      {
        title: 'Informacion y Data Tecnica',
        description: 'Actualizaciones normativas y tecnicas para decisiones seguras en el negocio diario.',
      },
      {
        title: 'Red y Beneficios',
        description: 'Vinculacion entre socios, oportunidades comerciales y acuerdos estrategicos.',
      },
    ],
    campaign: {
